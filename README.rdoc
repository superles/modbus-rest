...
Template: http://localhost:3000/{reg type}/{var type}/{reg addr(int)})/{value(write)}/{ip}/{port}/{slave id} 

Example read: http://localhost:3000/discrete_inputs/int/21/192_168_1_1/502/1  

Example write: http://localhost:3000/coil/int/22/1/192_168_1_1/502/1 
